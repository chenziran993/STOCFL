...
if __name__ == "__main__":
    ...
    clean_time_stamp = re.sub(r'[<>:"/\\|?*]', '_', args.time_stamp)
    dir = "./logs/runs-rotated-{}-n{}-p{}-seed{}-lambda{}-time-{}".format(args.dataset, args.n, args.num_per_round,args.seed, args.mu, clean_time_stamp)
    os.mkdir(dir)
